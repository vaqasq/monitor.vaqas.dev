...
func main() {
	...
	fmt.Printf("\nContainer List Data: %v", fetchContainerList(httpc))
	fmt.Printf("\nLive Container Metrics: %v", fetchLiveContainerMetrics(httpc)) // This is, by default, a live stream, but I made it just 1 json"
